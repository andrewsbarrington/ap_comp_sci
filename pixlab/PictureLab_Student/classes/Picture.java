...
public class Picture extends SimplePicture 
{
  ...
  public void newCopy(Picture fromPic, 
                 int startRow, int startCol, int endrow, int endcol,int pasterow, int pastecol)
  {
   ...
   public void myCollage()
  {
	...
	caterpillar.newCopy(caterpillar,6,57,40,88,65,215);
  ...
  public void edgeDetection(int edgeDist)
  {
    ...
    {
      for (int col1 = 0; 
           col1 < pixels[0].length; col1++)
      {
        topPixel = pixels[row1][col1];
        botPixel = pixels[row1+1][col1];
